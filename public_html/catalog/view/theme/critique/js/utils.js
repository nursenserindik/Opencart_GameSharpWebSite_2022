	...
	*/
	...
	window.critique_fixed_rows_height = function() {
		var with_admin_bar  = arguments.length > 0 ? arguments[0] : true,
			...
			oft             = with_admin_bar ? critique_adminbar_height() : 0;
	...
	window.critique_document_set_location = function(curLoc){
		try {
	...
	/* Debug functions
	---------------------------------------------------------------- */
	window.critique_debug_object = function(obj) {
		...
		if (level > 0) {
			...
			addStr   = critique_replicate( ' ', level * 2 );
		}
		if (obj !== null && (typeof(obj) == 'object' || typeof(obj) == 'array')) {
			for (var prop in obj) {
				...
				if (level < recursive && (typeof(obj[prop]) == 'object' || typeof(obj[prop]) == 'array') && obj[prop] != obj) {
					dispStr += addStr + prop + '=' + critique_debug_object( obj[prop], recursive, showMethods, level + 1 );
				} else {
					try {
						curStr = "" + obj[prop];
					} catch (e) {
	...
	window.critique_debug_log = function(s, clr) {
		if (CRITIQUE_STORAGE['user_logged_in']) {
	...
	window.dco === undefined && (window.dco = function(s,r) { console.log( critique_debug_object( s,r ) ); });
	window.dcs === undefined && (window.dcs = function() { console.trace(); });
	window.dal === undefined && (window.dal = function(s) { if (CRITIQUE_STORAGE['user_logged_in']) {
			alert( s );
	} });
	window.dao === undefined && (window.dao = function(s,r) { if (CRITIQUE_STORAGE['user_logged_in']) {
			alert( critique_debug_object( s,r ) );
	} });
	window.ddl === undefined && (window.ddl = function(s,c) { critique_debug_log( s,c ); });
	window.ddo === undefined && (window.ddo = function(s,r,c) { critique_debug_log( critique_debug_object( s,r ),c ); });
