...
if (in_array($args['slider_controls'], apply_filters('trx_addons_filter_slider_controls_outside', array('outside', 'top', 'bottom'), $args))) trx_addons_show_layout($controls);
