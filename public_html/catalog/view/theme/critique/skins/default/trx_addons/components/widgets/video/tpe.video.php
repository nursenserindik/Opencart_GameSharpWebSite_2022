...
if (settings.link != '' || settings.embed != '') {
	...
	#><div id="{{ id }}" class="trx_addons_video_player <# print(settings.cover.url != '' ? 'with_cover hover_play' : 'without_cover'); #>"><#
		if (settings.cover.url != '') {
			#><img src="{{ settings.cover.url }}" alt="<?php esc_attr_e("Video cover", 'critique'); ?>">
			<div class="video_mask"></div>
			<div class="video_hover style_<# print(_.escape(settings.button_style)); #>" data-video="<# print(_.escape(settings.embed)); #>"></div><#
		}
		#>
